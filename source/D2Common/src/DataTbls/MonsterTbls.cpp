...
void __fastcall DATATBLS_LoadMonStatsTxt(HD2ARCHIVE hArchive) {
	...
	D2BinFieldStrc pTbl[] = {
		...
		{ "NameStr", TXTFIELD_KEYTOWORD, 0, 6, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "DescStr", TXTFIELD_KEYTOWORD, 0, 8, (void*)DATATBLS_GetStringIdFromReferenceString },
...
void __fastcall DATATBLS_LoadMonStats2Txt(HD2ARCHIVE hArchive) {
	D2BinFieldStrc pTbl[] = {
		...
		{ "HDv", TXTFIELD_CUSTOMLINK, 0, 0, (void*)DATATBLS_MonStats2CompositLinker },
		{ "TRv", TXTFIELD_CUSTOMLINK, 0, 1, (void*)DATATBLS_MonStats2CompositLinker },
		{ "LGv", TXTFIELD_CUSTOMLINK, 0, 2, (void*)DATATBLS_MonStats2CompositLinker },
		{ "Rav", TXTFIELD_CUSTOMLINK, 0, 3, (void*)DATATBLS_MonStats2CompositLinker },
		{ "Lav", TXTFIELD_CUSTOMLINK, 0, 4, (void*)DATATBLS_MonStats2CompositLinker },
		{ "RHv", TXTFIELD_CUSTOMLINK, 0, 5, (void*)DATATBLS_MonStats2CompositLinker },
		{ "LHv", TXTFIELD_CUSTOMLINK, 0, 6, (void*)DATATBLS_MonStats2CompositLinker },
		{ "SHv", TXTFIELD_CUSTOMLINK, 0, 7, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S1v", TXTFIELD_CUSTOMLINK, 0, 8, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S2v", TXTFIELD_CUSTOMLINK, 0, 9, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S3v", TXTFIELD_CUSTOMLINK, 0, 10, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S4v", TXTFIELD_CUSTOMLINK, 0, 11, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S5v", TXTFIELD_CUSTOMLINK, 0, 12, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S6v", TXTFIELD_CUSTOMLINK, 0, 13, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S7v", TXTFIELD_CUSTOMLINK, 0, 14, (void*)DATATBLS_MonStats2CompositLinker },
		{ "S8v", TXTFIELD_CUSTOMLINK, 0, 15, (void*)DATATBLS_MonStats2CompositLinker },
...
void __fastcall DATATBLS_LoadMonTypeTxt(HD2ARCHIVE hArchive) {
	...
	D2BinFieldStrc pTbl[] = {
		...
		{ "strsing", TXTFIELD_KEYTOWORD, 0, 8, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "strplur", TXTFIELD_KEYTOWORD, 0, 10, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "end", TXTFIELD_NONE, 0, 0, NULL },
	};
...
void __fastcall DATATBLS_LoadMonPresetTxt(HD2ARCHIVE hArchive) {
	...
	D2BinFieldStrc pTbl[] = {
		...
		{ "Place", TXTFIELD_CUSTOMLINK, 0, 0, (void*)DATATBLS_MonPresetPlaceLinker },
		{ "end", TXTFIELD_NONE, 0, 0, NULL },
	};
...
void __fastcall DATATBLS_LoadMonEquipTxt(HD2ARCHIVE hArchive) {
	...
	for (int i = 0; i < sgptDataTables->nMonEquipTxtRecordCount; ++i) {
		...
		if (pMonStatsTxtRecord) {
			...
			for (int j = 0; j < 3; ++j) {
				if (pMonEquipTxtRecord->nLoc[j] <= BODYLOC_NONE || pMonEquipTxtRecord->nLoc[j] >= BODYLOC_SWRARM || pMonEquipTxtRecord->dwItem[j] != '    ' && FOG_GetLinkIndex(sgptDataTables->pItemsLinker, pMonEquipTxtRecord->dwItem[j], 1) < 0) {

...
void __fastcall DATATBLS_LoadPetTypeTxt(HD2ARCHIVE hArchive) {
	D2BinFieldStrc pTbl[] = {
		...
		{ "name", TXTFIELD_KEYTOWORD, 0, 12, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "end", TXTFIELD_NONE, 0, 0, NULL },
	};
...
void __fastcall DATATBLS_LoadCharStatsTxt(HD2ARCHIVE hArchive) {
	D2BinFieldStrc pTbl[] = {
		...
		{ "StrAllSkills", TXTFIELD_KEYTOWORD, 0, 82, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "StrSkillTab1", TXTFIELD_KEYTOWORD, 0, 84, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "StrSkillTab2", TXTFIELD_KEYTOWORD, 0, 86, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "StrSkillTab3", TXTFIELD_KEYTOWORD, 0, 88, (void*)DATATBLS_GetStringIdFromReferenceString },
		{ "StrClassOnly", TXTFIELD_KEYTOWORD, 0, 90, (void*)DATATBLS_GetStringIdFromReferenceString },
